    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            3 free AI interviews. No credit card. Upload your resume and get
            tailored questions in under 60 seconds.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            {[
              ...
              >
                <span style={{ color: T.accent, fontSize: 12, flexShrink: 0 }}>
                  ✓
                </span>
          ...
          <div style={{ borderLeft: `2px solid ${T.accent}`, paddingLeft: 16 }}>
            ...
            >
              "I practised 5 sessions on ScholarAI before my final interview.
              Landed the offer."
            </p>
            <div style={{ fontSize: 12, color: T.dim }}>
              — Recent user, got into Infosys
            </div>
          </div>
        </div>
